...
export default function SignIn() {
  ...
  return (
    <>
      ...
      <div className="sm:w-[416px]  w-[230px]  sm:mt-[8px] mt-[8px]">
        {/* add font  */}
        <label className="block text-right text-[18px] font-semibold font-vazirmatn text-[#685752] uppercase mb-[8px]">
          رمز عبور
        </label>
      ...
      <div className="sm:w-[416px] sm:h-[62px] w-[230px] h-[50px] mt-[8px] ">
        <button className="sm:w-[418px] sm:h-[52px] w-[231.81px] h-[42.15px]  mt-[24px] sm:mt-[36px] text-[18px] font-semibold font-vazirmatn bg-[url('/colorkitGreen.png')] bg-cover bg-center text-white py-2 px-6 rounded-[12px] hover:opacity-90 transition">
          ورود
        </button>
        <Link
