...
export const metadata = {
  ...
  description:
    "صفحه ای که به دنبال آن بودید پیدا نشد. می‌توانید به صفحه اصلی بازگردید یا یک گزارش جدید ثبت کنید.",
...
export default function NotFound() {
  return (
    <>
      ...
      <main
        dir="rtl"
        className="flex flex-col md:flex-row items-center justify-center bg-light pt-24 min-h-screen"
      >
        {/* Image */}
        ...
        {/* Text & Buttons */}
        <section className="flex flex-col items-center justify-center w-full md:w-1/2 text-center p-6 md:p-10">
          ...
          <p className="text-dark text-xl md:text-3xl mb-10 md:mb-20 leading-relaxed">
            ولی نگران نباش، گم شدن توی شهر هم جزئی از ماجراست.
            <br />
            به نظر می‌رسه صفحه‌ای که دنبالش بودی یا جابجا شده یا اصلاً وجود نداشته.
          </p>
          <p className="text-dark text-xl md:text-3xl mb-10 md:mb-20 leading-relaxed">
            بیا برگردیم به جایی که همه چی سر جاشه، یا یه گزارش جدید ثبت کن تا
            شهریار شادتر بشه.
          </p>
